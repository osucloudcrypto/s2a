...
const std::string SERVER_PORT = "29314";
...
static const string gcsDataStructureFilepath = "./banana/state/";
static const string gcsMatrixPiecePath = "./banana/EIDX/";


static const string gcsFilepath = "./banana/DB/";			                // path of input database

static const string gcsUpdateFilepath = "./banana/Update/";			        // Path of updated file
